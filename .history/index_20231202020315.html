...
const bool = {
  ...
  isLightTheme: (string) => lightThemes.includes(string),
}
...
const changeTheme = (theme) => {
  ...
  if (!theme || theme === "") {
    ...
    const handleIsLightTheme = (string) => bool.isLightTheme(string) ? 'light' : 'dark';
...
function initializeTopcoat() {



  const themeGroup = document.getAttribute("data-bs-theme");
  ...
  link.href = `./css/topcoat-${isDesktop ? 'desktop' : 'mobile'}-${themeGroup}.css`;
