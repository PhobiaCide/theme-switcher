...
const getSelectedMode = () => {
  ...
  const isDark = () => (parseInt(mode) >= 5); // Convert to a number for comparison
...
function donTopcoat() {
  ...
  const href = `css/topcoat/${isDesktop() ? 'desktop' : 'mobile'}/${getAppliedMode()}.css`; // Use template literal
