...
document.getElementById("theme-button-0").addEventListener("click", () => changeTheme("theme-0"));
document.getElementById("theme-button-1").addEventListener("click", () => changeTheme("theme-1"));
document.getElementById("theme-button-2").addEventListener("click", () => changeTheme("theme-2"));
document.getElementById("theme-button-3").addEventListener("click", () => changeTheme("theme-3"));
document.getElementById("theme-button-4").addEventListener("click", () => changeTheme("theme-4"));

document.getElementById("theme-button-5").addEventListener("click", () => changeTheme("theme-5"));
document.getElementById("theme-button-6").addEventListener("click", () => changeTheme("theme-6"));
document.getElementById("theme-button-7").addEventListener("click", () => changeTheme("theme-7"));
document.getElementById("theme-button-8").addEventListener("click", () => changeTheme("theme-8"));
document.getElementById("theme-button-9").addEventListener("click", () => changeTheme("theme-9"));
