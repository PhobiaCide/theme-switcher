...
function donTopcoat() {
  ...
  file.name = `topcoat-${isDesktop ? 'desktop' : 'mobile'}-${isDark(theme) ? 'dark' : 'light'}.min.css`;
  let index;
  if (isDesktop) {
...
const addresses = [
    "https://cdnjs.cloudflare.com/ajax/libs/topcoat/0.8.0/css/topcoat-desktop-dark.min.css",
    "https://cdnjs.cloudflare.com/ajax/libs/topcoat/0.8.0/css/topcoat-desktop-light.min.css",
    "https://cdnjs.cloudflare.com/ajax/libs/topcoat/0.8.0/css/topcoat-mobile-dark.min.css",
    "https://cdnjs.cloudflare.com/ajax/libs/topcoat/0.8.0/css/topcoat-mobile-light.min.css"
  ];
  ...
  const topcoat = document.getElementById("topcoat-stylesheet")
  topcoat.setAttribute("href", file.name);
