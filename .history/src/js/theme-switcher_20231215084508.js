...
document.getElementById("theme-switch-0").addEventListener("click", () => changeTheme(0));
document.getElementById("theme-switch-1").addEventListener("click", () => changeTheme(1));
document.getElementById("theme-switch-2").addEventListener("click", () => changeTheme(2));
document.getElementById("theme-switch-3").addEventListener("click", () => changeTheme(3));
document.getElementById("theme-switch-4").addEventListener("click", () => changeTheme(4));

document.getElementById("theme-switch-5").addEventListener("click", () => changeTheme(5));
document.getElementById("theme-switch-6").addEventListener("click", () => changeTheme(6));
document.getElementById("theme-switch-7").addEventListener("click", () => changeTheme(7));
document.getElementById("theme-switch-8").addEventListener("click", () => changeTheme(8));
document.getElementById("theme-switch-9").addEventListener("click", () => changeTheme(9));
